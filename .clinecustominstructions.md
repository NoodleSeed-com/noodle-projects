...
I proactively use Perplexity and other MCP servers for validation and research at every step of the development process:
...
Research findings and knowledge should be distributed to the most appropriate location:
